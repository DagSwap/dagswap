            ...
            <div className="space-y-4">
              <div className="rounded-[20px] bg-[#252550] p-4">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <TokenSelector selectedToken={token1} onSelectToken={setToken1} />
                </div>

                <div className="mt-2 text-sm text-white/70">
                  ${amount1 ? (Number.parseFloat(amount1) * 2500).toFixed(2) : "0.00"}
                </div>
              </div>
              ...
              <div className="rounded-[20px] bg-[#252550] p-4">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <TokenSelector selectedToken={token2} onSelectToken={setToken2} />
                </div>

                <div className="mt-2 text-sm text-white/70">
                  ${amount2 ? (Number.parseFloat(amount2) * 20).toFixed(2) : "0.00"}
                </div>
              </div>
          ...
          <TabsContent value="positions">
            {positions.length > 0 ? (
                  ...
                  <div key={index} className="rounded-[20px] bg-[#252550] p-4">
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm text-green-400">{position.apr} APR</div>
                      </div>
                    </div>
              ...
              <div className="text-center py-12">
                <p className="text-white/70">You don't have any liquidity positions yet.</p>
                <Button
                  variant="link"
